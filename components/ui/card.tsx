...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[1rem] border border-white/[0.12] bg-[linear-gradient(145deg,rgba(20,30,38,0.92),rgba(7,13,18,0.92))] text-card-foreground shadow-[inset_0_1px_0_rgba(255,255,255,0.07),0_14px_34px_rgba(0,0,0,0.24)] backdrop-blur-sm",
      className,
    )}
    {...props}
  />
